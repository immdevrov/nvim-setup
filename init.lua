...
require('packer').startup(function(use)
  ...
  use { 'prettier/vim-prettier', run = 'yarn install --frozen-lockfile --production', ft = { 'javascript', 'vue', 'json', 'typescript' }}

  use 'ThePrimeagen/harpoon'
  use 'f-person/git-blame.nvim' -- use :GitBlameToggle to toggle blame
